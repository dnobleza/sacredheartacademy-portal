...
app.use('/api/v1/admin/fees', require('./routes/admin/fees-routes'));
app.use('/api/v1/admin/fee-schedules', require('./routes/admin/fee-schedules-routes'));
app.use('/api/v1/admin/downpayments', require('./routes/admin/downpayments-routes'));
